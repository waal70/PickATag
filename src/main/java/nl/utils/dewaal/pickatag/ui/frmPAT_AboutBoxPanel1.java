...
public class frmPAT_AboutBoxPanel1 extends JPanel {
    /**
	 * 
	 */
    ...
    private void jbInit() throws Exception {
        ...
        labelTitle.setText( "The Pick A Tagline Custom Application" );
        labelAuthor.setText( "André de Waal" );
        labelCopyright.setText( "Copyright 2008-2013" );
        labelCompany.setText( "Irideos B.V." );
